...
public class BrutalityRuneProcedureProcedure {
	public static void execute(Entity entity) {
		...
		percentualattackspeed = new AttributeModifier(UUID.fromString("22571dfa-5a34-4b90-838f-816eaa46a531"), "AttackpeedPercentualAugment", 1.1, AttributeModifier.Operation.MULTIPLY_TOTAL);
