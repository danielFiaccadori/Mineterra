...
public class HumanAttributesProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE).setBaseValue((2 + (entity instanceof Player _plr ? _plr.experienceLevel : 0) / 40));
		...
		((LivingEntity) entity).getAttribute(MineterraModAttributes.MAGICDAMAGE.get()).setBaseValue((1 + (entity instanceof Player _plr ? _plr.experienceLevel : 0) / 50));
