...
public class RunicStoneResistenceBaubleIsEquippedProcedure {
	public static void execute(Entity entity) {
		...
		Nv1Resistence_2 = new AttributeModifier(UUID.fromString("86b28950-4bc0-496e-85ba-0a5c982f010e"), "ConstituitionAugment", (((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ARMOR).getValue() / 5),
				AttributeModifier.Operation.ADDITION);
		if (entity instanceof Player) {
			if (entity instanceof LivingEntity lv ? CuriosApi.getCuriosHelper().findEquippedCurio(MineterraModItems.RUNIC_STONE_RESISTENCE.get(), lv).isPresent() : false) {
				...
				if (!(((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ARMOR).hasModifier(Nv1Resistence_2)))
					((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ARMOR).addTransientModifier(Nv1Resistence_2);
			} else {
				...
				((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ARMOR).removeModifier(Nv1Resistence_2);
			}
		}
	}
}
