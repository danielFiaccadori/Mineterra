...
import net.mcreator.mineterra.network.AttributeUpgraderWisdomButtonMessage;
...
public class AttributeUpgraderWisdomScreen extends AbstractContainerScreen<AttributeUpgraderWisdomMenu> {
	private final static HashMap<String, Object> guistate = AttributeUpgraderWisdomMenu.guistate;
	...
	public AttributeUpgraderWisdomScreen(AttributeUpgraderWisdomMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("mineterra:textures/screens/attribute_upgrader_wisdom.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font,
				...
				DisplayWisdomProcedure.execute(entity), 69, 109, -1, false);
		guiGraphics.drawString(this.font,

				DisplayPointsProcedure.execute(entity), 61, -12, -13312, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.mineterra.attribute_upgrader_wisdom.label_available_attribute_points"), -82, -12, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.mineterra.attribute_upgrader_wisdom.label_this_attribute_is_mostly_recomme"), -78, 191, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.mineterra.attribute_upgrader_wisdom.label_constituition"), 74, 35, -256, false);
	}
	...
	public void init() {
		super.init();
		button_empty = Button.builder(Component.translatable("gui.mineterra.attribute_upgrader_wisdom.button_empty"), e -> {
			if (true) {
				MineterraMod.PACKET_HANDLER.sendToServer(new AttributeUpgraderWisdomButtonMessage(0, x, y, z));
				AttributeUpgraderWisdomButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}).bounds(this.leftPos + 98, this.topPos + 104, 30, 20).build();
		guistate.put("button:button_empty", button_empty);
		this.addRenderableWidget(button_empty);
		button_empty1 = Button.builder(Component.translatable("gui.mineterra.attribute_upgrader_wisdom.button_empty1"), e -> {
			if (true) {
				MineterraMod.PACKET_HANDLER.sendToServer(new AttributeUpgraderWisdomButtonMessage(1, x, y, z));
				AttributeUpgraderWisdomButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
