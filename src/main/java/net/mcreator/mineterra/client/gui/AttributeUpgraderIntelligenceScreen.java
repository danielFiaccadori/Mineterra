...
import net.mcreator.mineterra.network.AttributeUpgraderIntelligenceButtonMessage;
...
public class AttributeUpgraderIntelligenceScreen extends AbstractContainerScreen<AttributeUpgraderIntelligenceMenu> {
	private final static HashMap<String, Object> guistate = AttributeUpgraderIntelligenceMenu.guistate;
	...
	public AttributeUpgraderIntelligenceScreen(AttributeUpgraderIntelligenceMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("mineterra:textures/screens/attribute_upgrader_intelligence.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font,
				...
				DisplayIntelligenceProcedure.execute(entity), 69, 109, -1, false);
		guiGraphics.drawString(this.font,

				DisplayPointsProcedure.execute(entity), 61, -12, -13312, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.mineterra.attribute_upgrader_intelligence.label_available_attribute_points"), -82, -12, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.mineterra.attribute_upgrader_intelligence.label_this_attribute_is_mostly_recomme"), -82, 192, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.mineterra.attribute_upgrader_intelligence.label_constituition"), 59, 34, -13421569, false);
	}
	...
	public void init() {
		super.init();
		button_empty = Button.builder(Component.translatable("gui.mineterra.attribute_upgrader_intelligence.button_empty"), e -> {
			if (true) {
				MineterraMod.PACKET_HANDLER.sendToServer(new AttributeUpgraderIntelligenceButtonMessage(0, x, y, z));
				AttributeUpgraderIntelligenceButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}).bounds(this.leftPos + 98, this.topPos + 104, 30, 20).build();
		guistate.put("button:button_empty", button_empty);
		this.addRenderableWidget(button_empty);
		button_empty1 = Button.builder(Component.translatable("gui.mineterra.attribute_upgrader_intelligence.button_empty1"), e -> {
			if (true) {
				MineterraMod.PACKET_HANDLER.sendToServer(new AttributeUpgraderIntelligenceButtonMessage(1, x, y, z));
				AttributeUpgraderIntelligenceButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
