...
import net.mcreator.mineterra.procedures.RitualDaggerLivingEntityIsHitWithToolProcedure;
...
public class RitualDaggerItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		RitualDaggerLivingEntityIsHitWithToolProcedure.execute(entity, sourceentity, itemstack);
		return retval;
	}
