...
public abstract class TanzaniteArmorItem extends ArmorItem {
	public TanzaniteArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(MineterraModItems.TANZANITE.get()));
			}
	...
	public static class Helmet extends TanzaniteArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mineterra:textures/models/armor/tanzanite_layer_1.png";
		}
	}
	...
	public static class Leggings extends TanzaniteArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mineterra:textures/models/armor/tanzanite_layer_2.png";
		}
	}
