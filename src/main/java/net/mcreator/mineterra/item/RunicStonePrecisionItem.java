...
import net.mcreator.mineterra.procedures.RunicStonePrecisionWhileBaubleIsEquippedTickProcedure;
...
public class RunicStonePrecisionItem extends Item implements ICurioItem {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("- \u00A77+2 Dexterity"));
	...
	public void curioTick(SlotContext slotContext, ItemStack stack) {
		RunicStonePrecisionWhileBaubleIsEquippedTickProcedure.execute(slotContext.entity());
	}
}
