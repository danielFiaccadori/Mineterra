...
import net.mcreator.mineterra.procedures.NebulousVeilDaggerLivingEntityIsHitWithToolProcedure;

import java.util.List;

public class NebulousVeilDaggerItem extends SwordItem {
	public NebulousVeilDaggerItem() {
		super(new Tier() {
			public int getUses() {
				return 367;
			}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		NebulousVeilDaggerLivingEntityIsHitWithToolProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, sourceentity);
		return retval;
	}
