...
public class BowtwohandedlighticebowItem extends Item {
	public BowtwohandedlighticebowItem() {
		super(new Item.Properties().durability(3281));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					BowtwohandedlighticebowEntity entityarrow = BowtwohandedlighticebowEntity.shoot(world, entity, world.getRandom(), 3f, 0, 0);
