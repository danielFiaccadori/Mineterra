...
public class NetheriteClaymoreItem extends SwordItem {
	public NetheriteClaymoreItem() {
		super(new Tier() {
			public int getUses() {
				return 2032;
			}
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(MineterraModItems.NETHERITE_CLAYMORE.get()));
			}
