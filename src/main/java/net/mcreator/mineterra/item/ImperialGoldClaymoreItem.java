...
public class ImperialGoldClaymoreItem extends SwordItem {
	public ImperialGoldClaymoreItem() {
		super(new Tier() {
			public int getUses() {
				return 72;
			}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A7oUtilizada nas guerras do Caos, \u00E9 uma Espada Longa de Ouro que fora fortalecida pelos forjadores Imperiais."));
	}
}
